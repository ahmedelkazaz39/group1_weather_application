...
import 'package:group1_weather_application_g1d/controller/searchControlar.dart';
import '../../widget/MyCard.dart';
import '../../widget/appbarwidget.dart';
import '../../widget/chartSearch.dart';
import '../../widget/myList.dart';
import '../../widget/my_chart.dart';
import 'main_screen.dart';

class SerechScreen extends GetView<CitySearchController> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
appBar:  AppBarClass().getAppBar(context),
      body: GetBuilder<CitySearchController>(
        builder: (controller) {
          return Column(
            children: <Widget>[
              SizedBox(
